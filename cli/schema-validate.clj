...
;; (Tern primitive 5). Matches Anthropic Workflow's agent({schema}) gate: a sender attaches
;; a schema to a message/batch (msg-cli / tern-map), and the receiving side validates a worker's DONE
...
;;   * load-file'd by msg-cli.clj / tern-map.clj -> call (tern.schema-validate/validate-json p s)
