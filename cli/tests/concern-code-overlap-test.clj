...
;; tests/cnf_concern_overlap_test.clj; this guards the lodestar CLI seam.
...
(def lode (str (System/getProperty "user.home") "/code/lodestar"))
...
(def env {"LODESTAR_CODE_PORT" (str cport)})
