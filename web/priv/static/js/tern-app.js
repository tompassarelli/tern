...
(function () {
  ...
  function boot() {
    ...
    function show(key, opts) {
      ...
      mountInto(wb.content, window.tern && window.tern[v[2]], opts);
      current = key;
      paintToggle();
    }
    ...
    window.tern.focusGraph = (id) => show("graph", { focus: id });
    ...
    mountInto(ag.content, window.tern && window.tern.mountAgents);
  }
